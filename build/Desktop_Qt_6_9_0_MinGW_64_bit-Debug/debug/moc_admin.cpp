...
template <> constexpr inline auto Admin::qt_create_metaobjectdata<qt_meta_tag_ZN5AdminE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Admin",
        "on_tambahButton_clicked",
        "",
        "on_urutkanButton_clicked",
        "on_hapusButton_clicked",
        "on_pilihGambarButton_clicked",
        "on_pilihLaguButton_clicked",
        "on_logoutButton_clicked",
        "on_keUserButton_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_tambahButton_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_urutkanButton_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_hapusButton_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pilihGambarButton_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pilihLaguButton_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_logoutButton_clicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_keUserButton_clicked'
...
void Admin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_tambahButton_clicked(); break;
        case 1: _t->on_urutkanButton_clicked(); break;
        case 2: _t->on_hapusButton_clicked(); break;
        case 3: _t->on_pilihGambarButton_clicked(); break;
        case 4: _t->on_pilihLaguButton_clicked(); break;
        case 5: _t->on_logoutButton_clicked(); break;
        case 6: _t->on_keUserButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
